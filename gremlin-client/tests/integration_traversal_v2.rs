...
use gremlin_client::{utils, IoProtocol};
...
fn test_simple_vertex_traversal_v2() {
    let g = traversal().with_remote(graph_serializer(IoProtocol::GraphSONV2));
...
fn test_simple_vertex_traversal_with_id_v2() {
    let client = graph_serializer(IoProtocol::GraphSONV2);
